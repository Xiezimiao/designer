		...
		<div class="container">
			<div class="contact-top">
					...
					<div class="col-md-4 contact-column">
						...
						<p>
							<a href="mailto:example@gmail.com"><s:property
									value="#request.designer.email" /></a> <br>
							wechat:<s:property value="#request.designer.wechat" />
							<br>
							qq:<s:property value="#request.designer.qq" />
						</p>
					</div>
					<div class="col-md-4 contact-column">
						<i class="phone"></i>
				...
				<div class="contact-form">
					<div class="text">
						<input type="text" value="你的姓名" onfocus="this.value = '';"
