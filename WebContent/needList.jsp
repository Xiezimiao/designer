    ...
    <form action="./findneeds">
      <div class="sele selec_city">
        ...
        <div>
          ...
          <s:submit value="搜索" style="position: absolute;left: 400px;top:40px;width:50px;"/>
        </div>
      </div>
              ...
              <div class="list_info">
                <div class="_info">
                    <div><a href="./needsByID?needsId=${needs.needsId}" target="_blank"><s:property value="#needs.title"/></a>
                         ...
                         <a href="./needsByID?needsId=${needs.needsId}" style="margin-left: 480px;font-size:14px">查看详情</a>
                    <div class="jc_info">
