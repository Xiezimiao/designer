...
<body>
		...
		<div class="agile_dot_info one">
			<div class="container">
				...
				<div class="navbar-header navbar-left">
					...
					<h1>
						<a class="navbar-brand" href="index.html">室内设计交易平台</a>
					</h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right"
					...
					<ul class="nav navbar-nav">
						...
						<li><a href="projects.jsp">看案例</a></li>
						<li><a href="findneeds.action">找需求</a></li>
				...
				<div class="w3_agile_banner_info">
					...
					<div class="mainbutton">
						...
						<s:if test="%{#session.designer!=null}">
							<a href="#"><input class="button button_border" type="button"
								value="接受项目"></input></a>
	...
	<div class="special jarallax">
		<div class="container">
			<h3 class="w3ls_head">
				<span class="thr">Our </span>Features
			</h3>
			...
			<div class="special-grids">
				<div class="col-md-6 w3l-special-grid">
					<div class="col-md-6 w3ls-special-img"></div>
				...
				<div class="col-md-6 w3l-special-grid">
					<div class="col-md-6 w3ls-special-img wthree-img1"></div>
					<div class="col-md-6 agileits-special-info">
						<h4>Roof</h4>
						<p>Maecenas ac hendrerit purus. Lorem ipsum dolor sit amet</p>
					</div>
				...
				<div class="col-md-6 w3l-special-grid">
					...
					<div class="col-md-6 w3ls-special-img wthree-img2"></div>
				...
				<div class="col-md-6 w3l-special-grid">
					...
					<div class="col-md-6 w3ls-special-img wthree-img3"></div>
