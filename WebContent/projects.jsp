	...
	<div class="banner1 jarallax">
	  ...
	  <div class="searchframe">
		<form action="searchAllExample" method="post">
			<input class="searchtext" type="text" name="condition" placeholder="输入搜索条件" required="">
      ...
      <div class="subnav">
        <div id="selectList" class="screenBox screenBackground">
          ...
          <dl attr="terminal_os_s">
            ...
            <dd>
			    <div class="righttitle">
				  <label><input name="radio2" type="radio" value="" autocomplete="off"/>
				  <a href="javascript:;" value="">简约</a></label>
				  <label><input name="radio2" type="radio" value="" autocomplete="off"/>
				  <a href="javascript:;" value="">地中海</a></label>
				</div>
            </dd>
          </dl>
		  </div>
		  <div class="oneline">
          <dl attr="terminal_os_s">
            <dt class="lefttitle"><p>户型</p></dt>
            <dd>
			  <div class="righttitle">
              
			  <label><input name="radio1" type="radio" value="" autocomplete="off"/>
              <a href="javascript:;" value="">小户型</a></label>
              <label><input name="radio1" type="radio" value="" autocomplete="off"/>
              <a href="javascript:;" value="">一居室</a></label>
			</div>
            </dd>
          </dl>
		  </div>
					  <div class="oneline">
						  <dl attr="terminal_os_s">
							<dt class="lefttitle"><p>面积</p></dt>
							<dd>
							  <div class="righttitle">
							  
							  <label><input name="radio3" type="radio" value="" autocomplete="off"/>
							  <a href="javascript:;" value="">100m2</a></label>
							  <label><input name="radio3" type="radio" value="" autocomplete="off"/>
							  <a href="javascript:;" value="">120m2</a></label>
							</div>
							</dd>
						  </dl>
					  </div>
		  ...
		  <div class="resultList">
					  <div class="oneline" style="border-bottom: 0px;">
						<div>
							...
							<dt class="lefttitle"><p>已选条件</p></dt>
							<!--  clearDd    显示位置 -->
							<dd style="DISPLAY: none" class=clearDd>
								
								<div class="clearList  righttitle">
